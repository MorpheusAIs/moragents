...
with open('abi/distribution_abi.json', 'r') as file:
...
class Config:
    ...
    WEB3RPCURL = {"56": "https://bsc-dataseed.binance.org", "42161": "https://arb1.arbitrum.io/rpc",
                  "137": "https://polygon-rpc.com", "1": "https://cloudflare-eth.com",
