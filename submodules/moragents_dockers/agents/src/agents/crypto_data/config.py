...
class Config:
    ...
    FLOOR_PRICE_FAILURE_MESSAGE = (
        "Failed to retrieve floor price. Please enter a valid NFT name."
    )
    ...
    MARKET_CAP_FAILURE_MESSAGE = (
        "Failed to retrieve market cap. Please enter a valid coin name."
    )
