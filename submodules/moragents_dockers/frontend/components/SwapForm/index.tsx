...
export const SwapForm: FC<SwapFormProps> = ({
  ...
  const isNativeToken = useMemo(() => {
    if (!fromMessage || !fromMessage.src_address) {
      console.log("fromMessage or src_address is undefined");
      return false;
    }
  ...
  const [timeoutRefetchAllowance, setTimeoutRefetchAllowance] =
  ...
  const handleApprove = useCallback(
    async (address: string) => {
      ...
      try {
        ...
        if (!fromMessage) {
          console.error("fromMessage is undefined");
          return;
        }

        const { src_address, src_amount } = fromMessage;

        if (!src_address || !src_amount) {
          console.error("src_address or src_amount is undefined");
          return;
        }
